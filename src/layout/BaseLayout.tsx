    ...
    render() {
        return (
            <Layout style={{ minHeight: '100vh' }}>
                <Header style={{ position: 'fixed', zIndex: 1, width: '100%', background: "#315e8c", padding: 0, height: 46 }}>
                    <Menu
                        theme="dark" selectedKeys={[this.getCurrentPath()]} mode="horizontal" onClick={this.linkTo}>
                        <Menu.Item key="home">
